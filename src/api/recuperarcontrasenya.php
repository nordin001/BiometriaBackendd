<?php
    //-------------------------------------------------------------------------------------------------------
    //          email:text, nuevacontarsenya:text, confirmarcontarsenya:text --> recuperarcontrasenya()
    //-------------------------------------------------------------------------------------------------------
    $response = array('message' => '', 'error' => true);

        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            require_once("database.php");
            if (!empty($_POST['email']) && !empty($_POST['nuevacontrasenya']) && !empty($_POST['confirmarcontrasenya'])) {
            ...
            {
                $response['message'] = "Complete los campos por favor";
            }
        }
